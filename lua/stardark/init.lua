...
local theme = lush(function()
	...
	return {
		...
		FloatBorder({ bg = c.bg2.da(30), fg = c.fg2, gui = "NONE" }),
		NormalNC({ Normal }),
		...
		LspSagaSignatureHelpBorder({ fg = c.fg2, gui = "NONE" }),
		...
		-- telescope.nvim
		TelescopeSelection({ bg = "NONE", fg = c.fg3 }),
		TelescopeMatching({ bg = "NONE", fg = c.red, gui = "italic, bold" }),
		TelescopeBorder({ bg = "NONE", fg = c.fg4 }),
